...
#include "Adafruit_EPD.h" // requires Adafruit BusIO
...
Serial.print("Start SCD 30 calibration, please wait 30 s ...");delay(30000);
...
const char INDEX_HTML_END[] =
 ...
 String cal_passwort = "calscd30"; // Kalibrierpasswort
...
String messwertTabelle(){ 
  ...
  String nam1="Luftfeuchtigkeit";
  String nam2="Temperatur";
  String nam3="";

  float mess1=airSensorSCD30.getHumidity();
  float mess2=airSensorSCD30.getTemperature()-3;
  float mess3=0;
...
delay(1);
  ...
  display.setTextColor(EPD_BLACK);
  display.print("#IoT-Werkstatt");

  display.setTextSize(4);  
  display.setCursor(60, 60);
  display.setTextColor(EPD_RED);
  display.print(String(abs(mess)));

    display.setTextSize(2);  
  display.setCursor(10, 60);
  display.setTextColor(EPD_BLACK);
  display.print(String(abs(airSensorSCD30.getTemperature()-3))+"C");

    display.setTextSize(2);  
  display.setCursor(170, 60);
  display.setTextColor(EPD_BLACK);
  display.print(String(abs(airSensorSCD30.getHumidity()))+"%");
